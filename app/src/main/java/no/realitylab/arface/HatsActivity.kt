...
class HatsActivity : AppCompatActivity() {
    ...
    private var hats: ArrayList<ModelRenderable> = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_next_hat.setOnClickListener {
            changeModel = !changeModel
            index++
            if (index > hats.size - 1) {
                index = 0
            }
            faceRegionsRenderable = hats.get(index)
        }
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hat2.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                hats.add(modelRenderable)
                modelRenderable.isShadowCaster = false
        ...
        ModelRenderable.builder()
            .setSource(this, Uri.parse("hat3.sfb"))
            .build()
            .thenAccept { modelRenderable ->
                hats.add(modelRenderable)
                modelRenderable.isShadowCaster = false
